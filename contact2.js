...
function linkValue(contentId) {
    ...
    document.getElementById("Games").innerHTML = `<a class="nav-link aLink" href="games.html">Home</a>`
    document.getElementById("About").innerHTML = `<a class="nav-link aLink" href="about.html">Home</a>`
